...
describe("NachtBlau Hub Android Launcher", () => {
  ...
  it("exposes phone-install URLs for APK and live Android hub", () => {
    ...
    expect(LAUNCHER.codeAssistUrl).toContain("codeassist/NachtBlau-Hub");
    expect(LAUNCHER.codeAssistFolderUrl).toContain("codeassist/NachtBlau-Hub");
    expect(LAUNCHER.codeAssistZipUrl).toContain("NachtBlau-Hub.zip");
  });
