...
Das Affiliate-Banner ist im Footer aller GbR-Seiten eingebunden
(`index.html` / `index.htm` / `impressum.html` / `datenschutz.html`).

Nach Änderungen am Banner:

```bash
python3 scripts/upload-partner-banner.py
```
