...
$defs = [
    'profile' => [
        ...
        'label' => $displayLabel !== '' ? $displayLabel : t('nav.profile'),
        'avatar' => true,
    ],
    'friends' => [
...
<aside class="sidebar" aria-label="<?= e(t('nav.feed')) ?>">
  <nav class="sidebar-nav">
    ...
    <?php if (!$currentUser): ?>
      <a class="sidebar-link<?= $activeNav === 'login' ? ' active' : '' ?>" href="<?= e(allxion_url('login.php')) ?>" title="<?= e(t('nav.login')) ?>">
        <span class="sidebar-ico"><?= $ico('<path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><path d="M10 17l5-5-5-5"/><path d="M15 12H3"/>') ?></span>
        <span class="sidebar-label"><?= e(t('nav.login')) ?></span>
      </a>
      <a class="sidebar-link<?= $activeNav === 'register' ? ' active' : '' ?>" href="<?= e(allxion_url('register.php')) ?>" title="<?= e(t('nav.register')) ?>">
        ...
        <span class="sidebar-label"><?= e(t('nav.register')) ?></span>
      </a>
    <?php endif; ?>
  </nav>
</aside>
